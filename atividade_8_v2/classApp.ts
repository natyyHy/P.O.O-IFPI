...
import { ContaInexistenteError, NotNumber, ValorInvalidoError, ValorVazioError } from "./excecoes"
...
export class App {
    ...
    public depositar() : void {
        try{
            ...
            this.validarValor(valor_deposito)
    ...
    public sacar(): void {
        ...
        try {
            ...
            if(error instanceof ValorInvalidoError || error instanceof NotNumber || error instanceof ContaInexistenteError || error instanceof ValorVazioError){
                console.error(error.message);
            }
        }
    }
    ...
    private validaValorVazio(valor : number){
        if(valor === null){
        ...
        try{
            ...
            let conta_procurada : Conta = this.banco.consultar(numero);
                if(conta_procurada instanceof ContaSalario){
                    ...
                    this.validaValorVazio(novoLimite);
            ...
            if(error instanceof ValorVazioError || error instanceof ContaInexistenteError){
                console.error(error.message);
            }
        }
    ...
    public salvar_arquivo() : void {
        ...
        let caminho_arquivo : string = "C:\\Users\\natie\\OneDrive\\Documentos\\ADS-IFPI\\Modulo_2\\P.O.O\\atividade_08\\quest5\\classes\\contas.txt";
    ...
    public inserirConta() : void {
        print("\n Cadastrar Conta");
            ...
            let numero : string = input("digite o numero da conta:");
            let saldo_inicial : number = Number(input('Saldo inicial da conta '+ numero + ":"));
            ...
            if(opcao === 3){
                ...
                contaNova = new ContaPoupanca(numero,0,id_disponivel,null,taxa);
            }else if(opcao === 4){
                ...
                contaNova = new Conta(numero,saldo_inicial,id_disponivel,null)
            }
    ...
    public transferir() : void {
        print("\n Transferencia na Conta");
            ...
            this.banco.transferir(numero_origem,numero_destino,valor);
    }
