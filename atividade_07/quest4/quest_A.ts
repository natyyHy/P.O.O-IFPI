    ...
    public renderJuros(numeroPoupanca: string): void {
        ...
        if(conta){
            if(conta instanceof Poupanca){
                //usar cast seria redudante, instanceof ja verifica se é poupança
                //pode chamar diretamente o metodo renderJuros() sem precisar do cast
                conta.renderJuros();
            }else{
                console.log('conta nao é tipo poupança')
            }
        }else{
...
export {Banco, Cliente , Conta, Poupanca}