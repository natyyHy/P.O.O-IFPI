...
do {
    print('\nBem vindo\nDigite uma opção:'); 
    print('Contas:\n')
    print('1 - Inserir       2 - Consultar conta   3 - Sacar\n' + 
            '4 - Depositar     5 - Excluir      6 - Transferir\n' + 
      '7 – Totalizações   8 - Atualizar')
    print('Clientes:\n'); 
    print('9 - Inserir       10 - Consultar cliente por cpf    11 - Associar Conta a cliente   12 - Listar contas do cliente\n')
    print('13 - Total saldo cliente    ')
...
function transferir() : void {
    ...
    print("1 - Transferencia para uma conta    2 - Transferencia para varias contas")
    ...
    switch (opcao) {
        ...
        case '2' :
            numero_origem = input("Digite o número da conta origem: ");
            ...
            banco.transferir_contas(numero_origem,contas);
